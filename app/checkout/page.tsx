...
export default function CheckoutPage() {
  ...
  React.useEffect(() => {
    ...
    if (savedCart) {
      ...
      if (parsedCart.length === 0) {
        router.push("/cart"); // Don't let them checkout an empty cart
      } else {
  ...
  // Standard delivery fee. Could be dynamic based on the district later!
  ...
  return (
    <div className="min-h-screen bg-[#FFFDF9] font-sans text-[#0A192F] flex flex-col">
      ...
      {/* Breadcrumb / Progress Navigation */}
