...
const FEATURES = [
  {
    ...
    text: "Create a dining space that feels luxurious, welcoming, and perfect for memorable gatherings.",
  },
  {
    title: "Crafted Details",
    text: "From polished surfaces to premium upholstery, every detail is selected to enhance elegance.",
  },
  {
    ...
    <div className="min-h-screen bg-white font-sans text-[#0A192F]">
      ...
      <section className="relative h-[85vh] min-h-[560px] overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto h-full px-6 flex items-center">
          ...
          >
            <p className="text-[11px] uppercase tracking-[0.45em] text-[#D4AF37] mb-5">Dining Collection</p>
            ...
            <p className="text-sm md:text-base text-white/85 max-w-xl leading-7 mb-8">
              Explore sophisticated dining furniture crafted to make every meal feel elegant, warm, and unforgettable.
            </p>
      ...
      <section id="inspiration" className="grid grid-cols-1 lg:grid-cols-2 gap-0 bg-[#F7F7F7]">
        <div className="h-[520px] overflow-hidden">
          <img src="/dining-feature.jpg" alt="Dining room inspiration" className="w-full h-full object-cover" />
        </div>
        <div className="flex items-center px-8 md:px-16 py-16 bg-[#0A192F] text-white">
          <div className="max-w-xl">
            <p className="text-[10px] uppercase tracking-[0.45em] text-[#D4AF37] mb-4">Elegant Gatherings</p>
            ...
            <p className="text-sm text-white/80 leading-7 mb-8">
              Bring people together with luxurious dining tables, refined seating, and statement storage pieces that transform every gathering into a special occasion.
            </p>
      ...
      <section id="products" className="max-w-7xl mx-auto px-6 py-20">
        <div className="mb-10 flex items-center gap-4">
          <h2 className="text-2xl font-bold uppercase tracking-tighter">Dining Room Best Sellers</h2>
