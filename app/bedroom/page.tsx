...
const FEATURES = [
  {
    ...
    text: "Create a bedroom that feels calm, elegant, and deeply comfortable every single day.",
  },
  {
    title: "Soft Sophistication",
    text: "Rich finishes, upholstered details, and timeless forms designed to elevate your personal space.",
  },
  {
    title: "Beautiful Function",
    text: "Beds, storage, and accent pieces that balance style, warmth, and everyday practicality.",
  },
];
    ...
    <div className="min-h-screen bg-white font-sans text-[#0A192F]">
      ...
      <section className="relative h-[85vh] min-h-[560px] overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto h-full px-6 flex items-center">
          ...
          >
            <p className="text-[11px] uppercase tracking-[0.45em] text-[#D4AF37] mb-5">Bedroom Collection</p>
            ...
            <p className="text-sm md:text-base text-white/85 max-w-xl leading-7 mb-8">
              Discover luxurious bedroom furniture designed to bring calm, comfort, and timeless beauty into your private retreat.
            </p>
      ...
      <section id="inspiration" className="grid grid-cols-1 lg:grid-cols-2 gap-0 bg-[#F7F7F7]">
        <div className="h-[520px] overflow-hidden">
          <img src="/bedroom-feature.jpg" alt="Bedroom inspiration" className="w-full h-full object-cover" />
        </div>
        <div className="flex items-center px-8 md:px-16 py-16 bg-[#0A192F] text-white">
          <div className="max-w-xl">
            <p className="text-[10px] uppercase tracking-[0.45em] text-[#D4AF37] mb-4">Personal Sanctuary</p>
            <h2 className="text-4xl md:text-5xl font-extralight uppercase tracking-[0.16em] mb-6">
              Designed for Restful Living
            </h2>
            <p className="text-sm text-white/80 leading-7 mb-8">
              Build a serene and luxurious bedroom with elegant bed frames, sophisticated storage, and refined accent furniture that turns every night into a retreat.
            </p>
      ...
      <section id="products" className="max-w-7xl mx-auto px-6 py-20">
        <div className="mb-10 flex items-center gap-4">
          <h2 className="text-2xl font-bold uppercase tracking-tighter">Bedroom Best Sellers</h2>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-24">
        <div className="bg-[#D4AF37] text-[#0A192F] px-8 md:px-16 py-14 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div>
            ...
            <h3 className="text-3xl md:text-4xl font-bold uppercase tracking-wide">Transform Your Bedroom Retreat</h3>
          </div>
          <a href="/">
